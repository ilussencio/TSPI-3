...
insert into conta_corrente values (1,'2020-03-15', 50,'Ativa',1);
insert into conta_corrente values (2,'2020-03-18',500,'Ativa',2);
...
insert into registro_saque values(1,2,'2020-03-20', 20);
insert into registro_saque values(2,2,'2020-04-20', 80);


insert into registro_deposito values(1,2,'2020-03-19', 40);
insert into registro_deposito values(2,2,'2020-04-22', 800);
